...
<div class="card-grid card-grid-3">
  <a href="/research/analytical-science/hplc-analysis-peptides/" class="card"><h3>HPLC Analysis of Peptides</h3>Monitoring degradation products by HPLC analysis.</p></a>
  <a href="/research/analytical-science/purity-testing-methods/" class="card"><h3>Purity Testing Methods</h3>Detecting degradation-related impurities.</p></a>
  <a href="/methods/peptide-storage-stability/" class="card"><h3>Peptide Storage and Stability Method</h3>Practical guidance for maintaining peptide stability.</p></a>
</div>
